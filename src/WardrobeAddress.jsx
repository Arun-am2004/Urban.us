...
const WardrobeAddress = () => {
    ...
    const handleCheckout = () => {
        ...
        const price = selectedOption === 'rent' ? 'Price based on selected tenure' : '$600';
        setCheckoutDetails(`Selected Option: ${selectedOption.toUpperCase()}. Total Price: ${price}. Address: ${address}`);
    };

    return (
        <div className="details-box">
            <h1>Wardrobe {selectedOption && selectedOption.toUpperCase()} - Address Details</h1>
...
export default WardrobeAddress;
