...
const BedAddress = () => {
    ...
    const handleCheckout = () => {
        ...
        const price = selectedOption === 'rent' ? 'Price based on selected tenure' : '$800';
        setCheckoutDetails(`Selected Option: ${selectedOption.toUpperCase()}. Total Price: ${price}. Address: ${address}`);
    };

    return (
        <div className="details-box">
            <h1>Bed {selectedOption && selectedOption.toUpperCase()} - Address Details</h1>
